...
function addRecordToTable(data) {
    var userList = document.getElementById("userList").getElementsByTagName("tbody")[0];
    var newRecord = userList.insertRow(userList.length);
    ...
    cell4.innerHTML = data.full_name;
